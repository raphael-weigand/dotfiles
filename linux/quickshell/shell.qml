                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        Rectangle {
                            ...
                            color: wifiCardMouse.containsMouse ? "#2b2b2b" : "#222222"
                            border.width: 1; border.color: wifiEnabled ? "#ffdd33" : "#303030"
                            RowLayout {
                                ...
                                ColumnLayout { Layout.fillWidth: true; spacing: 2
                                    Label { text: "Wi-Fi"; color: "#ffffff"; font.family: "Iosevka Term Extended"; font.bold: true }
                                    Label { text: wifiText; color: "#999999"; font.family: "Iosevka Term Extended"; font.pixelSize: 10; elide: Text.ElideRight; Layout.fillWidth: true }
                                }
                        ...
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: 76; radius: 12
                            color: bluetoothCardMouse.containsMouse ? "#2b2b2b" : "#222222"
                            border.width: 1; border.color: bluetoothEnabled ? "#ffdd33" : "#303030"
                            RowLayout {
                                anchors.fill: parent; anchors.margins: 12; spacing: 10
                                ...
                                ColumnLayout { Layout.fillWidth: true; spacing: 2
                                    Label { text: "Bluetooth"; color: "#ffffff"; font.family: "Iosevka Term Extended"; font.bold: true }
                                    Label { text: bluetoothText; color: "#999999"; font.family: "Iosevka Term Extended"; font.pixelSize: 10; elide: Text.ElideRight; Layout.fillWidth: true }
                                }
                        ...
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: 92; radius: 12
                            color: audioCardMouse.containsMouse ? "#2b2b2b" : "#222222"; border.width: 1; border.color: "#303030"
                            ColumnLayout {
                                ...
                                RowLayout { Layout.fillWidth: true; spacing: 9
                                    ...
                                    ColumnLayout { Layout.fillWidth: true; spacing: 1
                                        Label { text: "Audio"; color: "#ffffff"; font.family: "Iosevka Term Extended"; font.bold: true }
                                        Label { text: audioOutputName + " · " + (volumeMuted ? "Muted" : volumePercent + "%"); color: "#999999"; font.family: "Iosevka Term Extended"; font.pixelSize: 10; elide: Text.ElideRight; Layout.fillWidth: true }
                                    }
                                    Label { text: "›"; color: outputMouse.containsMouse ? "#ffdd33" : "#777777"; font.pixelSize: 20 }
                                }
                                Slider { Layout.fillWidth: true; from: 0; to: 1.5; value: volumeLevel; onMoved: { volumeLevel = value; volumePercent = Math.round(value * 100); volumeSet.command = ["wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", value.toFixed(2)] }; onPressedChanged: if (!pressed) { volumeSet.running = true; Qt.callLater(function() { audioStatus.running = true }) } }
                            }
                        ...
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: 92; radius: 12
                            color: displayCardMouse.containsMouse ? "#2b2b2b" : "#222222"; border.width: 1; border.color: "#303030"
                            ColumnLayout {
                                anchors.fill: parent; anchors.margins: 12; spacing: 5
                                RowLayout { Layout.fillWidth: true; spacing: 9
                                    ...
                                    ColumnLayout { Layout.fillWidth: true; spacing: 1
                                        Label { text: "Display"; color: "#ffffff"; font.family: "Iosevka Term Extended"; font.bold: true }
                                        Label { text: "Brightness · " + brightnessPercent + "%"; color: "#999999"; font.family: "Iosevka Term Extended"; font.pixelSize: 10 }
                                    }
                                }
                                Slider { Layout.fillWidth: true; from: 1; to: 100; value: brightnessPercent; onMoved: { brightnessPercent = Math.round(value); brightnessSet.command = ["brightnessctl", "set", brightnessPercent + "%"] }; onPressedChanged: if (!pressed) { brightnessSet.running = true; Qt.callLater(function() { brightnessStatus.running = true }) } }
                            }
